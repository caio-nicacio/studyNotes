...
\begin{document}
	...
	$$\left.\frac{\partial^2 f}{\partial x^2}\right|_{m,n} \approx \frac{\left.\frac{\partial f}{\partial x}\right|_{m+\frac{1}{2},n}-\left.\frac{\partial f}{\partial x}\right|_{m-\frac{1}{2},n}}{\Delta x}$$
	$$\left.\frac{\partial^2 f}{\partial y^2}\right|_{m,n} \approx \frac{\left.\frac{\partial f}{\partial y}\right|_{m,n+\frac{1}{2}}-\left.\frac{\partial f}{\partial y}\right|_{m,n-\frac{1}{2}}}{\Delta y}$$
\end{document}