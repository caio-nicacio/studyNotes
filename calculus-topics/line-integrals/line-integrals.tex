...
\begin{document}
	...
	\section{Integral de linha de primeira ordem}
	\label{sec:integral-linha}
	...
	\end{equation*}
	Como a $\boldsymbol{\vec{F}}\cdot \frac{d\gamma}{dt}$ em $[a,b]$ é integrável e contínua no intervalo, segue que
	\begin{equation*}
	...
	\begin{equation}
		\int_{a}^{b} \boldsymbol{\vec{F}}\cdot d\gamma=\int_{a}^{b} \left\langle \boldsymbol{\vec{F}}(\gamma(t)), \frac{\gamma(t)}{dt}\, dt \right\rangle.
