...
\begin{document}
	...
	\end{equation*}
	Portanto, $\gamma_2$ é obtida de $\gamma_1$ por uma \textbf{mudança de parâmetro que conserva a orientação}\footnote{O domínio de $\gamma_1$ é função do domínio de $\gamma_2$.}. Assim, $\exists g:D_{\gamma_1}\to D_{\gamma_2}$ de modo a igualar as duas curvas.
